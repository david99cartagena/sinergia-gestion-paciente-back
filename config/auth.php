...
return [
    ...
    */
    ...
    php artisan make:migration create_tipos_documento_table
    php artisan make:migration create_genero_table
    php artisan make:migration create_pacientes_table 
    */

    /* 
    php artisan make:seeder DepartamentosSeeder
    php artisan make:seeder MunicipiosSeeder
    php artisan make:seeder TiposDocumentoSeeder
    php artisan make:seeder GeneroSeeder
    php artisan make:seeder UsersTableSeeder
    php artisan make:seeder PacientesSeeder 
    */
